...
parser.add_argument("-d", "--data", required=False, default="/Users/johnleland/Desktop/TS-Extrinsic-Regression/Monash_UEA_UCR_Regression_Archive/")
parser.add_argument("-p", "--problem", required=False, default="AppliancesEnergy")  # see data_loader.regression_datasets
parser.add_argument("-c", "--regressor", required=False, default="fcnattention")  # see regressor_tools.all_models
parser.add_argument("-i", "--iter", required=False, default=10)
